...
public class AssignmentService {
    ...
    private ProjectDAO prj = new ProjectDAO();
    private ProjectService project = new ProjectService();
        ...
        try {
            ...
            String insert =
                    "INSERT INTO resource_assignment " +
                            "(resource_id, project_code, client_code, quantity, assignment_date, return_date ,total_cost, status) " +
                            "VALUES (?, ?, ?, ?, CURDATE(), ?, ?, ?)";
