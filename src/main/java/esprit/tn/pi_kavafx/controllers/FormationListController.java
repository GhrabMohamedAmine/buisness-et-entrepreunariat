...
public class FormationListController {
    ...
    private void openDetails(int formationId) {
        try {
            ...
            LayoutController.instance.contentArea.getChildren().setAll(page);
    ...
    private void openEdit(int formationId) {
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/fxml/formation_edit.fxml"));
            Node page = loader.load();
            ...
            DialogUtil.error("Erreur", "Ouverture modification impossible.\n" + e.getMessage());
        }
    }
}
