...
public class chatController {
    ...
    private int currentUserId = UserService.getCurrentUser().getId();
    ...
    private void showIncomingCallPopup(long convId,
        ...
        overlay.getStylesheets().add(getClass().getResource("/org/example/yedikpromax/chat-view.css").toExternalForm());
