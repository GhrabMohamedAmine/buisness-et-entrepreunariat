...
public class ClientQuizCardController {
    ...
    public void initialize(){
        ...
        a1.setOnAction(e -> highlight(a1));
        a2.setOnAction(e -> highlight(a2));
        a3.setOnAction(e -> highlight(a3));
    }
    public void setData(Quiz q, BiConsumer<Quiz,Integer> onAnswer){
        ...
        if(q.getImage()!=null && !q.getImage().isEmpty()){
            ...
            if(imgFile.exists()){
                ...
                // show container ONLY if image exists
    ...
    private void setupAnswer(Button btn,int index,Quiz q,BiConsumer<Quiz,Integer> onAnswer){
        ...
        btn.setOnAction(e->{
            ...
            btn.getStyleClass().add("selected-answer");            selected=index;
