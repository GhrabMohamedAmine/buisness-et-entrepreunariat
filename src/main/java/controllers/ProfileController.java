...
public class ProfileController implements Initializable {
    ...
    @Override
     public void initialize(URL location, ResourceBundle resources) {
        ...
        if(contentArea != null){
            utils.Router.setMainContainer(contentArea);

            // default page after login
            utils.Router.goTo("formation_list.fxml");
        }
    ...
    public void goformation(ActionEvent event) {
        ...
        if ("Employer".equals(userConnecte.getRole())) {
            utils.Router.goTo("client_formation_list.fxml");
    ...
    public void goresultat(ActionEvent event) {

             utils.Router.goTo("client_results.fxml");
